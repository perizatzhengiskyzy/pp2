...
background = pygame.image.load("C:\pp22\pp2\lab8\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\pp22\pp2\lab8\Enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\pp22\pp2\lab8\coin.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\pp22\pp2\lab8\Player.png")
        self.rect = self.image.get_rect()
