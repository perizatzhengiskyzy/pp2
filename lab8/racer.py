...
road = pygame.image.load("C:\pp22\pp2\lab8\AnimatedStreet.png")
coin_i = pygame.image.load("C:\pp22\pp2\lab8\Coin.png")

coin_im = pygame.transform.scale(coin_i, (100, 100))
player_im = pygame.image.load("C:\pp22\pp2\lab8\Player.png")
